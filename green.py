...
Simple green-light control script for the Arduino running lights_camera_action.ino.

Usage:
    py -3.10 green.py --port COM4 on
    py -3.10 green.py --port COM4 off

Optional:
    py -3.10 green.py --port COM4 on --baud 115200
"""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Turn green illumination on/off via Arduino serial.")
    parser.add_argument("state", choices=["on", "off"], help="Turn green light on or off.")
